    ...
    <div id="bigData" class="container-fuild">
      <div class="row bigData-container">
        <div class="col-xs-12 col-sm-12 col-md-6 wow zoomIn">
          <img class="img-responsive" src="@/assets/img/img1.png" alt="大数据安全分析系统">
        </div>
        <div class="col-xs-12 col-sm-12 col-md-6">
          <h2 class="bigData-title">
            大数据安全分析系统
            <small>/ Advanced Threat Detection System</small>
          </h2>
          <p> 高级持续性威胁（APT）是指隐匿而持久的网络入侵过程，其通常是出于商业或政治动机，由某些人员精心策划，针对特定组织或国家， 长时间内保持高隐蔽性，最后实施攻击。APT通过0day漏洞、特种木马变种、病毒变种等手段可以轻易绕过大部分传统安全设备， 基于特征检测的传统安全产品对APT的未知威胁攻击形同虚设。</p>
          <p>将人工智能、大数据技术与安全技术相结合，实时分析网络流量，监控可疑威胁行为。 ATD不仅可以通过多病毒检测引擎有效识别出病毒、木马等已知威胁；通过基因图谱检测技术检测恶意代码变种； 还可以通过沙箱（Sandbox）行为检测技术发现未知威胁，对检测及防御APT攻击起到关键作用。</p>
